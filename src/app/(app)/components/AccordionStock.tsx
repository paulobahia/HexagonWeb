...
function AccordionStock({ sideBar }: { sideBar: boolean }) {
    ...
    return (
        <>
            <div onClick={openAccordionStock} className={`flex items-center  ${sideBar ? "justify-between" : 'justify-center'} group px-2 py-3 hover:bg-zinc-400/30 rounded-lg transition-colors cursor-pointer `}>
